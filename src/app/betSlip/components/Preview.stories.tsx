...
const meta: Meta<typeof PreviewBuilder> = {
...
export const DesktopLongTextPreview: Story = {
    args: {
...
And I am a material girl
    ...
    render: (args) => <PreviewBuilder {...args} />,
}

export const DesktopShortTextPreview: Story = {
    args: {
        previewType: PreviewType.Desktop,
        text: `
        一見你就有好心情，剩下聰明的人才看得見 ... 
